import { postData, getData, formatDate, base64_decode, utf8_decode } from '../../utils/utils.js';
var app =  getApp();
...
Page({
  ...
  scanCode(){
    wx.scanCode({
      ...
      success(res) {
        console.log(res);
        console.log(res.result.substring(0, 24)); 
        console.log(base64_decode(res));
      }
    })  
  }
