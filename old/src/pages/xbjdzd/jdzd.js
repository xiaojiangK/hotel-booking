  ...
  goDetail(e) {
    wx.getStorage({
      ...
      success: (res) => {
        ...
        if (this.data.isVipMember == 1 | 1) {
          wx.navigateTo({
            url: `jdzdDetail?id=${e.currentTarget.dataset.id}&startDate=${startDate}&endDate=${endDate}&latitude=${res.data.latitude}&longitude=${res.data.longitude}&hotel_id=${e.currentTarget.dataset.id}&wx_target=${e.currentTarget.dataset.wx_target}&hotelname=${e.currentTarget.dataset.hotelname}&rebate=${e.currentTarget.dataset.rebate}&address=${e.currentTarget.dataset.address}&hotel_qrcode_url=${e.currentTarget.dataset.hotel_qrcode_url}&uid=${this.data.uid}`
          });
        }
        else {
